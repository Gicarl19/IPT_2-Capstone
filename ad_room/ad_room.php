...
<head>
    ...
    <link rel="stylesheet" href="/style/room/rooms.css">
...
<nav id="sidebar">
    <ul>
        ...
        <li>
    <a href="/ad_folder/verify_accounts.php">
...
<div class="main-content">
    ...
    <div class="floors-container">
        ...
        <div class="floor">
            <h2>3rd Floor</h2>
            <div class="room-grid">
                <form action="/ad_room/room301.php" method="get">
                    <button type="submit" class="room-button">Room 301</button>
                </form>
                <form action="/ad_room/room302.php" method="get">
                    <button type="submit" class="room-button">Room 302</button>
                </form>
            </div>
        </div>
        ...
        <div class="floor">
            <h2>4th Floor</h2>
            <div class="room-grid">
                <form action="/ad_room/room401.php" method="get">
                    <button type="submit" class="room-button">Room 401</button>
                </form>
                <form action="/ad_room/room402.php" method="get">
                    <button type="submit" class="room-button">Room 402</button>
                </form>
            </div>
        </div>
        ...
        <div class="floor">
            <h2>5th Floor</h2>
            <div class="room-grid">
                <form action="/ad_room/room501.php" method="get">
                    <button type="submit" class="room-button">Room 501</button>
                </form>
                <form action="/ad_room/room502.php" method="get">
                    <button type="submit" class="room-button">Room 502</button>
                </form>
            </div>
        </div>
    </div>
