...
<head>  
    ...
    <link rel="stylesheet" href="/style/user/userpage.css">
...
<nav id="sidebar">
    ...
    <main>
        <div class="container">
            <h1>VISION</h1>
            <p>A leading university that is committed to the advancement of human lives and global competitiveness through academic excellence, research, and community linkages.</p>
        </div>
