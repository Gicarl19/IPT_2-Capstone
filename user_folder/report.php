...
<head>
    ...
    <title>Enhanced Report Page</title>
...
<nav id="sidebar">
    ...
    <main>
        <section class="container">
            ...
            <h1>Submit Your Details and Comments</h1>
            
            <form action="/submit_report.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="userDetails">Name and Upload Picture:</label>
                    <input type="text" id="userName" name="userName" placeholder="Enter your name" required>
                    <input type="file" id="userPicture" name="userPicture" accept="image/*" required>
                </div>
                <div class="form-group">
                    <label for="userComments">Comments:</label>
                    <textarea id="userComments" name="userComments" placeholder="Write your comments here" required></textarea>
                </div>
