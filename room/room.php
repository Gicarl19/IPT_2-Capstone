...
<div class="main-content">
    ...
    <div class="floors-container">
        ...
        <div class="floor">
            <h2>3rd Floor</h2>
            <div class="room-grid">
                <form action="/room/room301.php" method="get">
                    <button type="submit" class="room-button">Room 301</button>
                </form>
                <form action="/room/room302.php" method="get">
        ...
        <div class="floor">
            <h2>4th Floor</h2>
            <div class="room-grid">
                <form action="/room/room401.php" method="get">
                    <button type="submit" class="room-button">Room 401</button>
                </form>
                <form action="/room/room402.php" method="get">
        ...
        <div class="floor">
            <h2>5th Floor</h2>
            <div class="room-grid">
                <form action="/room/room501.php" method="get">
                    <button type="submit" class="room-button">Room 501</button>
                </form>
                <form action="/room/room502.php" method="get">
