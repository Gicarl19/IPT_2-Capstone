...
$sql = "SELECT * FROM reports ORDER BY submissionTime DESC";
...
<head>
    ...
    <link rel="stylesheet" href="/style/ad_report.css">
...
<nav id="sidebar">
    ...
    <li>
        ...
        <ul class="sub-menu">
            <div>
                <li><a href="/dashboard.php">&nbsp&nbsp&nbspDashboard</a></li>
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <img src="/uploads/<?php echo htmlspecialchars($row['userPicture']); ?>" alt="User Picture" width="100" onclick="openModal('/uploads/<?php echo htmlspecialchars($row['userPicture']); ?>')">
                            </td>
                            <td><?php echo htmlspecialchars($row['userComments']); ?></td>
    ...
    <div id="image-modal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background-color:rgba(0,0,0,0.8); z-index:1000; justify-content:center; align-items:center;">
        <img id="modal-image" style="max-width:100%; max-height:100%; margin:auto; display:block;">
        <span style="position:absolute; top:20px; right:20px; color:white; font-size:2rem; cursor:pointer;" onclick="closeModal()">×</span>
    </div>
</body>
<script>
