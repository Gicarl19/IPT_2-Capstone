...
$conn = new mysqli('localhost', 'root', '#0000', 'user_db');
...
if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] === 0) {
    ...
    if (in_array($_FILES['profile_picture']['type'], $allowed_types) && $_FILES['profile_picture']['size'] <= $max_size) {
        $upload_dir = '/pro_uploads/uploads/';        
        ...
        if (move_uploaded_file($_FILES['profile_picture']['tmp_name'], $target_file)) {
            ...
            // Add this after the file upload attempt
if (!move_uploaded_file($_FILES['profile_picture']['tmp_name'], $target_file)) {
    $error_message = "Failed to upload: " . error_get_last()['message'];
    error_log("Upload failed: " . $target_file . " - " . error_get_last()['message']);
}
        } else {
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="user_page.php">Dashboard</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                <div class="col-md-4 text-center">
                    <?php if(isset($user['profile_picture']) && !empty($user['profile_picture'])): ?>
                        <img src="../uploads/<?php echo $user['profile_picture']; ?>" alt="Profile Picture" class="profile-picture">                    <?php else: ?>
